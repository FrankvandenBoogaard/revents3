// 188. Creating our own cloud functions
...
exports.addFollowing = functions.firestore
  ...
  .onCreate(async (snapshot, context) => {
    ...
    try {
      ...
      // Dit is serverside, dus niet te zien in client.
      // Moet met 'return' anders wordt functie niet geaccepteerd door Firestore
    }
  });
...
// 191. Adding functions for the feed
